      ...
      <div className="AboutBlock">
        <div className="AboutUsText">
          ...
          <p>
            ...
            maiores tempora nostrum ex corrupti repudiandae a, exercitationem
            velit dolorem aliquam possimus? Lorem ipsum dolor sit amet,
            consectetur adipisicing elit. Et, iure totam eaque debitis,
            perspiciatis ad temporibus consequatur quaerat ut dolorum minus
            inventore ipsa laborum voluptate in minima exercitationem
            repudiandae cum. Lorem ipsum dolor sit amet, consectetur adipisicing
            elit. Voluptatem eveniet corporis soluta aperiam amet porro nemo,
            incidunt magni est molestiae rem eligendi, eos vel ipsam
            necessitatibus! Iste inventore ipsam asperiores?
            C:\Users\asus\Desktop\ecommerce\Exclusive-Ecommerce-Site\ecommerce-site\src\assets\Images\Side
            Image.png
          </p>
        </div>
        <br />
        ...
        <div className="AboutUsSidePicture">
          <img
