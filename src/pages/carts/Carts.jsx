      ...
      <div className="ct_content">
        ...
        <div className="ct_data">
          <div className="ct_general">
            <div><p className="ct_Product"><b>Product</b></p></div>
            <div><p className="ct_Size"><b>Size</b></p></div>
            <div><p className="ct_Quality"><b>Quality</b></p></div>
            <div><p className="ct_Remove"><b>Remove</b></p></div>
            <div><p className="ct_Price"><b>Price</b></p></div>
          </div>
          <hr />
        ...
        <div className="ct_promo">
          ...
          <div className="ct_checkbox">
            <button className="ct_second"> <Link to="/checkout">Checkout</Link> </button>
