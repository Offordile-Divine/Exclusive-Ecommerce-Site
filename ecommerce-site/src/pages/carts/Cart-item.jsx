        ...
        <tbody>
            ...
            <td>
              <div className="ct_countHandler">
                <button type="button" onClick={() => handleIncrease(id)} className="ct_positive"><b>+</b></button>
                <input value={cartItems[id]} onChange={(e)=>updateCartItemCount(Number(e.target.value),id)} />
                <button type="button" onClick={() => handleDecrease(id)} className="ct_negative"><b>-</b></button>
              </div>
             </td>

            <td className="ct_remove"><button>X</button></td>
